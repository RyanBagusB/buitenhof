  ...
  <body>
    ...
    <main id="mainContent">
      <section class="jumbotron">
        <figure>
          <img src="https://awsimages.detik.net.id/community/media/visual/2023/12/25/rumah-berusia-ratusan-tahun-milik-emah-84-di-dusun-hambawang-desa-padaasih-kecamatan-conggeang-sumedang-1.jpeg?w=600&q=90" alt="Jumbotron Image" />
          <figcaption>
